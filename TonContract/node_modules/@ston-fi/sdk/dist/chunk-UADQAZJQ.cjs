...
var _chunk666S76J6cjs = require('./chunk-666S76J6.cjs');

// src/contracts/dex/v1/LpAccountV1.ts



var _ton = require('@ton/ton');
var LpAccountV1 = (_class = class _LpAccountV1 extends _chunkIIMQROIVcjs.Contract {
  static __initStatic() {this.version = _chunk666S76J6cjs.DEX_VERSION.v1}
  static __initStatic2() {this.gasConstants = {
    refund: _ton.toNano.call(void 0, "0.3"),
    directAddLp: _ton.toNano.call(void 0, "0.3"),
    resetGas: _ton.toNano.call(void 0, "0.3")
  }}
  ...
  async createRefundBody(params) {
    return _ton.beginCell.call(void 0, ).storeUint(_chunkAZDNTOBWcjs.DEX_OP_CODES.REFUND_ME, 32).storeUint(_nullishCoalesce(_optionalChain([params, 'optionalAccess', _ => _.queryId]), () => ( 0)), 64).endCell();
  }
  /**
  ...
  async getRefundTxParams(provider, params) {
    ...
    const value = BigInt(_nullishCoalesce(_optionalChain([params, 'optionalAccess', _3 => _3.gasAmount]), () => ( this.gasConstants.refund)));
  ...
  async createDirectAddLiquidityBody(params) {
    return _ton.beginCell.call(void 0, ).storeUint(_chunkAZDNTOBWcjs.DEX_OP_CODES.DIRECT_ADD_LIQUIDITY, 32).storeUint(_nullishCoalesce(_optionalChain([params, 'optionalAccess', _4 => _4.queryId]), () => ( 0)), 64).storeCoins(BigInt(params.amount0)).storeCoins(BigInt(params.amount1)).storeCoins(BigInt(_nullishCoalesce(params.minimumLpToMint, () => ( 1)))).endCell();
  }
  /**
  ...
  async createResetGasBody(params) {
    return _ton.beginCell.call(void 0, ).storeUint(_chunkAZDNTOBWcjs.DEX_OP_CODES.RESET_GAS, 32).storeUint(_nullishCoalesce(_optionalChain([params, 'optionalAccess', _5 => _5.queryId]), () => ( 0)), 64).endCell();
  }
  /**
  ...
  async getResetGasTxParams(provider, params) {
    ...
    const value = BigInt(_nullishCoalesce(_optionalChain([params, 'optionalAccess', _7 => _7.gasAmount]), () => ( this.gasConstants.resetGas)));
    return { to, value, body };
  }
...
//# sourceMappingURL=chunk-UADQAZJQ.cjs.map