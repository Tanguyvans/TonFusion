...
var _chunkZ57JZ7TTcjs = require('./chunk-Z57JZ7TT.cjs');


var _chunkWYCQKPBZcjs = require('./chunk-WYCQKPBZ.cjs');
...
var BaseRouterV2_1 = (_class = class _BaseRouterV2_1 extends _chunkIIMQROIVcjs.Contract {
  static __initStatic() {this.version = _chunk666S76J6cjs.DEX_VERSION.v2_1}
  ...
  async getPool(provider, params) {
    ...
    return _chunkZ57JZ7TTcjs.BasePoolV2_1.create(poolAddress);
  }
  ...
  async getVault(provider, params) {
    ...
    return _chunkWYCQKPBZcjs.VaultV2_1.create(vaultAddress);
  }
...
//# sourceMappingURL=chunk-KJI252NX.cjs.map