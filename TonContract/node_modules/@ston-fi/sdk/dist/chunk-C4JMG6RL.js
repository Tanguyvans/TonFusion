...
var PoolV1 = class _PoolV1 extends JettonMinter {
  ...
  async createCollectFeesBody(params) {
    return beginCell().storeUint(DEX_OP_CODES.COLLECT_FEES, 32).storeUint(params?.queryId ?? 0, 64).endCell();
  }
  /**
  ...
  async createBurnBody(params) {
    return beginCell().storeUint(DEX_OP_CODES.BURN, 32).storeUint(params?.queryId ?? 0, 64).storeCoins(BigInt(params.amount)).storeAddress(toAddress(params.responseAddress)).storeMaybeRef().endCell();
  }
  /**
...
//# sourceMappingURL=chunk-C4JMG6RL.js.map