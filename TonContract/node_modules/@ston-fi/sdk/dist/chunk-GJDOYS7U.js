...
var BasePoolV2_1 = class _BasePoolV2_1 extends JettonMinter {
  ...
  async createBurnBody(params) {
    return beginCell().storeUint(DEX_OP_CODES.BURN, 32).storeUint(params?.queryId ?? 0, 64).storeCoins(BigInt(params.amount)).storeAddress(null).storeMaybeRef(params.dexCustomPayload).endCell();
  }
...
//# sourceMappingURL=chunk-GJDOYS7U.js.map